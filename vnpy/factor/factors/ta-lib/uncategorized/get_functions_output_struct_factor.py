...
class GET_FUNCTIONS_OUTPUT_STRUCTFactor(FactorTemplate):
    """
    Calculates the GET_FUNCTIONS_OUTPUT_STRUCT indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "GET_FUNCTIONS_OUTPUT_STRUCT"

    def __init__(self, setting: dict | None = None, vt_symbols: list[str] | None = None, **kwargs):
        """
        Initializes the GET_FUNCTIONS_OUTPUT_STRUCTFactor.
    ...
    def calculate(self, input_data: Dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            result_expr = plta.get_functions_output_struct(**symbol_inputs, **kwargs)
