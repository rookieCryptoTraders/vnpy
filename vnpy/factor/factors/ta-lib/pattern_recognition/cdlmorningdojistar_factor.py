...
class CDLMORNINGDOJISTARFactor(FactorTemplate):
    """
    ...
    def __init__(self, setting: dict | None = None, vt_symbols: list[str] | None = None, **kwargs):
        """
        Initializes the CDLMORNINGDOJISTARFactor.
        ...
        try: self.penetration = float(self.params.penetration)
        except (ValueError, TypeError): self.penetration = int(self.params.penetration)
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            result_expr = plta.cdlmorningdojistar(**symbol_inputs, **kwargs)
