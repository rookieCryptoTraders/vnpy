...
class CDLRISEFALL3METHODS(FactorTemplate):
    """
    Calculates the CDLRISEFALL3METHODS indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLRISEFALL3METHODS"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLRISEFALL3METHODS.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlrisefall3methods(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
