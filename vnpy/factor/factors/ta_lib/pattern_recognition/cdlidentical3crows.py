...
class CDLIDENTICAL3CROWS(FactorTemplate):
    """
    Calculates the CDLIDENTICAL3CROWS indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLIDENTICAL3CROWS"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLIDENTICAL3CROWS.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlidentical3crows(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
