...
class CDLHARAMI(FactorTemplate):
    """
    Calculates the CDLHARAMI indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "cdlharami"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLHARAMI.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlharami(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
