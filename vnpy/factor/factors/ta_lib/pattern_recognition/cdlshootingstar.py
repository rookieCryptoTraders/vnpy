...
class CDLSHOOTINGSTAR(FactorTemplate):
    """
    Calculates the CDLSHOOTINGSTAR indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLSHOOTINGSTAR"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLSHOOTINGSTAR.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlshootingstar(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
