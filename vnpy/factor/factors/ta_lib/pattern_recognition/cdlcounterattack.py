...
class CDLCOUNTERATTACK(FactorTemplate):
    """
    Calculates the CDLCOUNTERATTACK indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLCOUNTERATTACK"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLCOUNTERATTACK.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlcounterattack(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
