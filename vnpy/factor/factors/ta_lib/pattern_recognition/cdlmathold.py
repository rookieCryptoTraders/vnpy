...
class CDLMATHOLD(FactorTemplate):
    """
    Calculates the CDLMATHOLD indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLMATHOLD"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLMATHOLD.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlmathold(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
