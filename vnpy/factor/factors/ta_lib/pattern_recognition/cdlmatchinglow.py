...
class CDLMATCHINGLOW(FactorTemplate):
    """
    Calculates the CDLMATCHINGLOW indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "cdlmatchinglow"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLMATCHINGLOW.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlmatchinglow(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
