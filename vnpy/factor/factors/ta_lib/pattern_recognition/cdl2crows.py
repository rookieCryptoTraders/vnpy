...
class CDL2CROWS(FactorTemplate):
    """
    Calculates the CDL2CROWS indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDL2CROWS"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDL2CROWS.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdl2crows(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
