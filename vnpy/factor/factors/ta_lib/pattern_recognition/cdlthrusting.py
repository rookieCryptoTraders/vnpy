...
class CDLTHRUSTING(FactorTemplate):
    """
    Calculates the CDLTHRUSTING indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLTHRUSTING"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLTHRUSTING.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlthrusting(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
