...
class CDL3INSIDE(FactorTemplate):
    """
    Calculates the CDL3INSIDE indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDL3INSIDE"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDL3INSIDE.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdl3inside(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
