...
class CDLXSIDEGAP3METHODS(FactorTemplate):
    """
    Calculates the CDLXSIDEGAP3METHODS indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "cdlxsidegap3methods"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLXSIDEGAP3METHODS.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlxsidegap3methods(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
