...
class CDLUNIQUE3RIVER(FactorTemplate):
    """
    Calculates the CDLUNIQUE3RIVER indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "CDLUNIQUE3RIVER"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the CDLUNIQUE3RIVER.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.cdlunique3river(open=pl.col("open"), high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
