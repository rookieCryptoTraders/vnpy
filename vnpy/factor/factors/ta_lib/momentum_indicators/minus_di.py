...
class MINUS_DI(FactorTemplate):
    """
    Calculates the MINUS_DI indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "MINUS_DI"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the MINUS_DI.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.minus_di(high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
