...
class AROON_AROONDOWN(FactorTemplate):
    """
    Calculates the AROON_AROONDOWN indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "AROON_AROONDOWN"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the AROON_AROONDOWN.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.aroon(high=pl.col("high"), low=pl.col("low"), **kwargs).alias("result")
