...
class PPO(FactorTemplate):
    """
    Calculates the PPO indicator.
    """
    ...
    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the PPO.
        Required parameters: fastperiod, slowperiod, matype
        """
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        kwargs = { "fastperiod": self.fastperiod, "slowperiod": self.slowperiod, "matype": self.matype }
        output_series_list = []
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.ppo(real=pl.col("real"), **kwargs).alias("result")
