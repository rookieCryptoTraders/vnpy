...
class MACDFIX_MACDSIGNAL(FactorTemplate):
    """
    Calculates the MACDFIX_MACDSIGNAL indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "MACDFIX_MACDSIGNAL"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the MACDFIX_MACDSIGNAL.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.macdfix(real=pl.col("real"), **kwargs).alias("result")
