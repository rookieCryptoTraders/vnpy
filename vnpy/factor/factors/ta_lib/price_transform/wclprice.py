...
class WCLPRICE(FactorTemplate):
    """
    Calculates the WCLPRICE indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "WCLPRICE"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the WCLPRICE.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.wclprice(high=pl.col("high"), low=pl.col("low"), close=pl.col("close"), **kwargs).alias("result")
