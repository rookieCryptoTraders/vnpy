...
class HT_SINE_LEADSINE(FactorTemplate):
    """
    Calculates the HT_SINE_LEADSINE indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "HT_SINE_LEADSINE"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the HT_SINE_LEADSINE.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.ht_sine(real=pl.col("real"), **kwargs).alias("result")
