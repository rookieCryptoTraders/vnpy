...
class HT_PHASOR_QUADRATURE(FactorTemplate):
    """
    Calculates the HT_PHASOR_QUADRATURE indicator.
    """

    author = "Auto-Generated by FactorGenerator"
    factor_name = "HT_PHASOR_QUADRATURE"

    def __init__(self, setting: dict | None = None, **kwargs):
        """
        Initializes the HT_PHASOR_QUADRATURE.
    ...
    def calculate(self, input_data: dict[str, pl.DataFrame], memory: FactorMemory) -> pl.DataFrame:
        ...
        for symbol in symbol_columns:
            ...
            calc_expression = plta.ht_phasor(real=pl.col("real"), **kwargs).alias("result")
